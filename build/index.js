...
var AuthProvider = /** @class */ (function () {
    function AuthProvider(options) {
        ...
        this.login = function (_a) {
            ...
            return auth.Auth.signIn(username, password, clientMetadata);
        };
        this.changePassword = function (_a) {
            ...
            return auth.Auth.changePassword(user, oldPassword, newPassword, clientMetadata);
        };
        ...
        this.checkAuth = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, auth.Auth.currentSession()];
                    case 1:
                        session = _a.sent();
...
var DataProvider = /** @class */ (function () {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api.API.graphql({
                            query: query,
                            variables: variables,
...
var AmplifyAdmin = function (_a) {
    ...
    return (React__default.createElement(reactAdmin.Admin, __assign({}, propsRest, { authProvider: buildAuthProvider({ authGroups: authGroups }), dataProvider: buildDataProvider(operations) }), children));
};
...
var AmplifyFilter = function (_a) {
    ...
    return React__default.createElement(reactAdmin.Filter, __assign({}, rest), filters.map(renderInput));
};

exports.AmplifyAdmin = AmplifyAdmin;
exports.AmplifyFilter = AmplifyFilter;
